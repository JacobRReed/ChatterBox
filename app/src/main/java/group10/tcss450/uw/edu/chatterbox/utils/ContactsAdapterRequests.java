...
public class ContactsAdapterRequests extends RecyclerView.Adapter<ContactsAdapterRequests.ViewHolder>{

    private List<Contact> mContacts;

    public ContactsAdapterRequests(List<Contact> contacts) {
        mContacts = contacts;
    }
